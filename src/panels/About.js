...
- Вместо кнопки "Настройки" сделали кнопку "Истории"<br/>
- Сделали так, чтобы при нажатие на кнопку "Истории" Вас перекидывало на создание истории с рекламой нашего сервиса (Фото, при публикации - не наше, это пример, взятый с VK API)<br/>
...
<Separator wide /><br/>
<center className="vers" onClick={props.go} data-to="donate">beta 0.2.6</center><br/>
